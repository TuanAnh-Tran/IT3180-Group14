...
export class AuthService {
   ...
   */
  static async updateProfile(fullname, phone, room) {
    const currentUser = this.getCurrentUser();
    if (!currentUser) {
    ...
    const updatedUser = await ApartmentDB.updateProfile(currentUser.username, { fullname, phone, room }, currentUser.username);
