  ...
  static async render(container, user) {
    ...
    container.innerHTML = `
      ...
      <div class="dashboard-grid">
        ...
        <!-- Khu vực hiển thị Nhật ký (Admin) hoặc Thông báo (Cư dân) -->
        ${isAdmin ? `
        <div class="chart-card">
          <div class="card-header">
            <div>
        ...
        <div class="chart-card">
          <div class="card-header">
            <div>
              <h2 class="card-title">Announcements & Guidelines</h2>
              <p class="card-title-muted">Building management office updates</p>
            </div>
          </div>
          <div class="activity-list" style="max-height: 280px; overflow-y: auto;">
            <div class="activity-item info">
              <div class="activity-dot"></div>
              <div class="activity-details">
                <div class="activity-text"><strong>Monthly Fees Due Date:</strong> Please settle all household utility and maintenance fees before the 10th of every month.</div>
                <div class="activity-time">Important Notice</div>
              </div>
            </div>
            <div class="activity-item success">
              <div class="activity-dot"></div>
              <div class="activity-details">
                <div class="activity-text"><strong>Management Hotline:</strong> For emergency repairs, water leaks, or security assistance, please call <strong>024.1234.5678</strong>.</div>
                <div class="activity-time">Contacts</div>
              </div>
            </div>
            <div class="activity-item info">
              <div class="activity-dot"></div>
              <div class="activity-details">
                <div class="activity-text"><strong>Profile Validation:</strong> Please verify your household and identity details in your profile settings. Ensure your CCCD/CMND is correct.</div>
                <div class="activity-time">Account Settings</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="chart-card" style="background: linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, rgba(6, 182, 212, 0.1) 100%);">
        ...
        <p style="color: var(--text-secondary); font-size: 14px; line-height: 1.6;">
          ...
          ${isAdmin ? 'As a member of the <strong>Management Office (Admin)</strong>, you can manage resident accounts, assign system access permissions, and audit the complete activity logs of the system.' : 'As a registered <strong>Resident</strong> of unit <strong>' + user.room + '</strong>, you can view billing overviews, receive announcements, update your contact details, and change your password security.'}
        </p>
      </div>
    `;
  }
