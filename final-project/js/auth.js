...
export class AuthService {
  ...
  static async register(userData) {
    ...
    if (!username || !password) {
      throw new Error('Please fill in all required fields (Username, Password)!');
    }
    ...
    // Tiến hành tạo tài khoản. Hàm này sẽ ném ra lỗi trùng lặp/kiểm tra dữ liệu nếu không hợp lệ
